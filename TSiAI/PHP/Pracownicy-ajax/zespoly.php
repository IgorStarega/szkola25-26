        ...
        <form id="zespolyForm">
            <div class="d-flex flex-wrap justify-content-between align-items-center p-4 bg-light shadow-sm rounded my-4 gap-3">
                <div class="input-group" style="max-width: 500px;">
                    ...
                    <button class="btn btn-primary" type="button" onclick="searchZespoly(); return false;">Szukaj</button>
                    <input type="button" id="zespolyReset" class="btn btn-danger" value="Reset" onclick="resetZespoly(); return false;" />
                </div>
                <div>
