...
foreach($stmt as $row){
    ...
    $html .= '<td><button type="button" class="btn btn-outline-secondary me-2" onclick="alert(\'edycja niedostępna w popup - użyj przycisku w wierszu\')"><i class="bi bi-pencil-square"></i></button>';
